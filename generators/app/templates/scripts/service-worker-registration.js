...
<%= projectNameUpperCase %>.ServiceWorkerRegistration = (function () {
  'use strict';
    ...
    if (!isAlreadyRegistered) {
      ...
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register(URL, {
          ...
          <%= projectNameUpperCase %>.Analytics.trackError('navigator.serviceWorker.register() error', e);
  ...
  if (navigator.serviceWorker && navigator.serviceWorker.controller) {
    navigator.serviceWorker.controller.onstatechange = function (event) {
      if (event.target.state === 'redundant') {
        ...
        if (<%= projectNameUpperCase %>.Elements && <%= projectNameUpperCase %>.Elements.Template &&
          <%= projectNameUpperCase %>.Elements.Template.$.toast.show) {
          <%= projectNameUpperCase %>.Elements.Template.$.toast.show(
